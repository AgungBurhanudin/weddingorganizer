...
$waktu = $arr_trx->waktu;
$noid = $arr_trx->noid;
$judul_struk = 'STRUK BPJS KETENAGAKERJAAN';
$idpel = $jst->idpel;
$nama = $jst->nama;
$lembar = $jst->lembar;
$ref = $jst->reff;
...
$pesan = "Rincian Tagihan dapat diakses pada www.bpjsketenagakerjaan.go.id";
