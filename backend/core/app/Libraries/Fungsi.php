...
class Fungsi
{
    ...
    public static function randomNumber($length = 12)
    {
        $chars = '0123456789';
    ...
    public static function randomNumberTiket($length = 12)
    {
        $chars = '123456789';
    ...
    public static function merchantCode($merchant)
    {
        switch ($merchant) {
            case "DESKTOP":
                $kode = '6025'; //6021
    ...
    public function getNamaBulanShort($bulan)
    {
        switch ($bulan) {
            case "01":
                $kode = 'JAN';
    ...
    public static function rupiah($rup)
    {
        $rup = number_format($rup + 0, 0, '', '.');
        return $rup;
    }

    public static function rupiahd($rup)
    {
    ...
    public static function rupiaht($rup)
    {
    ...
    public static function rupiahb($rup)
    {
    ...
    public static function spasi($jml, $char)
    {
        $result  = '';
    ...
    public static function spasiKanan($jml, $char)
    {
        $result  = '';
        $spasi   = '';
        $selisih = $jml - strlen($char);
    ...
    public static function namaStrukKanan()
    {
        return '';
    }

    public static function namaStrukKiri()
    {
        return '';
    }
    ...
    public static function get_unique_id($index = null)
    {
        if (!empty($index)) {
            $unique = uniqid($index);
        } else {
    ...
    public function getNoHpEmail($nohpemail, $tipe){
    ...
    public static function getNumberOfDay($tanggal)
    {
